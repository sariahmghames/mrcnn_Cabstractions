...
Written by Sariah Mghames on top of the version proposed by Waleed Abdulla
"""
...
############################################################
#  Custom Callbacks: for mAP output on training examples
############################################################
...
class MeanAveragePrecisionCallback(Callback):
    def __init__(self, train_model: MaskRCNN, inference_model: MaskRCNN, dataset: None,
        ...
        print('calculate map/Xepoch=', self.calculate_map_at_every_X_epoch)
    ...
    def on_epoch_end(self, epoch, logs=None):
        print('I will test printing out mAP for training dataset ')

        if (epoch > 0) and (epoch+0)%self.calculate_map_at_every_X_epoch == 0:
            print('I will start printing out mAP for training dataset')
    ...
    def _calculate_mean_average_precision(self):
        ...
        for image_id in self.dataset_image_ids[:self.dataset_limit]:
            ...
            mAPs.append(AP)
        #print("mAP from training dataset : ", np.mean(mAPs))

        return mAPs #np.array(mAPs)
